package com.bintina.mynews.features.search.adapter
...
class Adapter() : RecyclerView.Adapter<com.bintina.mynews.features.search.adapter.Adapter.ItemViewHolder>() {
